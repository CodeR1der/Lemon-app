          ...
          itemBuilder: (context, index) {
            ...
            return GestureDetector(
              ...
              child: Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start, // Прижимаем элементы к левой стороне
                  children: [
                    // Картинка (аватар)
                    Padding(
                    ...
                    // Название проекта
                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 16.0), // Отступы вокруг текста
                      child: Text(
                        project.name,
                        style: TextStyle(
                          fontSize: 16,
                        ...
                        textAlign: TextAlign.left, // Выравнивание текста по левой стороне
                        overflow: TextOverflow.ellipsis, // Обрезание текста, если он слишком длинный
                      ),
                    ),
                  ],
                ),
